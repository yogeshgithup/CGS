<%-- 
    ...
    Created on : Oct 11, 2018, 2:32:29 PM
    Author     : sneh pael
--%>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
               <div class="col-sm-4"> 
                        <a href="addbatches.html"> <button type="button" class="btn btn-primary pull-right">ADD BATCHES
                        </button></a>
                        </div>
                    </div>
                <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title" align="Center">BATCHES</h4>
