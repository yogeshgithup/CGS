 ...
 * @author Chiman Patel
 */
public class Counterreporttype extends HttpServlet {
...
//
        ...
        jasperDesign = JRXmlLoader.load(path + "/gymui/Jasperreport/counter.jrxml");
        ...
        File f = new File(path + "TRAFFIC_REPORT_BASED_ON_TYPE.pdf");
        ...
        String fn = "TRAFFIC_REPORT_BASED_ON_TYPE.pdf";
