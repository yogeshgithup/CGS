 ...
 * @author Chiman Patel
 */
public class Trafficreportall extends HttpServlet {
...
//
        ...
        jasperDesign = JRXmlLoader.load(path + "/gymui/Jasperreport/pagehitsall.jrxml");
        ...
        File f = new File(path + "TRAFFIC_REPORT_BASED_ON_ALL.pdf");
        ...
        String fn = "TRAFFIC_REPORT_BASED_ON_ALL.pdf";
