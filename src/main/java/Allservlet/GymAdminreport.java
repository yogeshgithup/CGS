 ...
 * @author Chiman Patel
 */
public class GymAdminreport extends HttpServlet {
    ServletContext scx;
...
//        System.out.println("-----------------------59");
 ...
 HttpSession hs=request.getSession(true);
        ...
        parameters.put("gymid", gymid);
        String path = getServletContext().getRealPath("/");
        System.out.println("path==68-----" + path);
        jasperDesign = JRXmlLoader.load(path + "/gymui/Jasperreport/GymAdminReport.jrxml");
        ...
        File f = new File(path + "GYMREPORT.pdf");
