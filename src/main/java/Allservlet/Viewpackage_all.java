 ...
 * @author Shravan
 */
public class Viewpackage_all extends HttpServlet {
...
*/          //  request.setAttribute("setpackage",listCatagory);
           ...
           hs.setAttribute("viewpack",listCatagory);
          if(hs!=null)
          {
              response.sendRedirect(scx.getContextPath()+"/gymui/pannel/managepackage.jsp");
          }
