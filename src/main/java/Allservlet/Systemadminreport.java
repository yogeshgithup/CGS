 ...
 * @author Chiman Patel
 */
public class Systemadminreport extends HttpServlet {
...
//
        ...
        jasperDesign = JRXmlLoader.load(path + "/gymui/Jasperreport/SystemAdminReport.jrxml");
        ...
        File f = new File(path + "SYSTEMADMIN_REPORT.pdf");
        ...
        String fn = "SYSTEMADMIN_REPORT.pdf";
