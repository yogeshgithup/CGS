				...
				<div class="banner-info-text">
					<div class="container">
						<div class="agileits-logo">
							<h1><a href="#"><%String g=(String)session.getAttribute("gymname");
			...
			<div class="gallery-w3lsrow">
				<div class="col-sm-3 col-xs-4 gallery-grids">
					<div class="w3ls-hover">
						<a href="<%=application.getContextPath()%>/gymui/images/images/g1.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
							<img src="<%=application.getContextPath()%>/gymui/images/images/g1.jpg" class="img-responsive zoom-img" alt=""/>
		...
		<div class="container">	
			...
			<div class="teamw3-agileinfo">
				<div class="col-md-3 col-xs-6 team-wthree-grid">
					<div class="btm-right">
						<img src="<%=application.getContextPath()%>/gymui/images/images/t1.jpg" alt=" ">
