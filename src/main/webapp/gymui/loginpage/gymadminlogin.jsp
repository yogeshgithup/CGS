<%-- 
    Document   : gymadminlogin
    Created on : Oct 16, 2018, 2:21:31 PM
    Author     : sneh pael
--%>
...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<%=application.getContextPath()%>/gymui/images/system.png"/>
<!--===============================================================================================-->
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<%=application.getContextPath()%>/gymui/images/system.png" alt="IMG">
				</div>
