          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                ...
                <h5 class="title">ABOUT US DETAIL</h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title"  required="About Us Required" placeholder="About Us">
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="desc" required="Description Required" placeholder="About Us Description">
                      </div>
                    </div>
                  </div>
