            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title" align="Center">MAIN PAGE EDITING</h4>
                ...
                <div class="card-body">
                  <form action="<%=application.getContextPath()%>/Aaddgyminfo" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-2">
                        <label class=" form-control-label">Logo</label></div>
                          <div  class="col-md-3"><input type="file" name="logo"  class="form-control-file " required></div>
                      </div>
                    
                      <div class="row">   
                            <div class="col-md-2">
                        <label  class=" form-control-label">Slider Image</label></div>
                          <div  class="col-md-3"><input type="file"  name="image" class="form-control-file " required></div>
                      </div>
                       <div class="col-md-3">
                       ...
                       <div class="row">  
                          ...
                          <input type="text" class="form-control" name="imagedesc" required>
                        </div>
                            </div>
                       </div>
                   <div class="row">  
                      ...
                      <div class="col-md-6">
                        <div class="form-group" >
                          ...
                          </br>  <input type="text" class="form-control" name="title" required>
                        </div>
                      </div>                       
                    <div class="col-md-6">
                          <div class="form-group">
                        <label for="comment" class="bmd-label-floating">Achievement Description:</label>
                        <textarea class="form-control" rows="5" id="comment" name="descr" required></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="qualitymsg" required>
                        </div>
                      </div> 
