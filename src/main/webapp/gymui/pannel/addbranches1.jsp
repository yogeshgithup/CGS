                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="branchname" id="branchname" required="Branch Name Required" placeholder="Branch Name">
                      </div>
                    </div>
                      <div class="col-md-6 px-1">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 px-1">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="postalcode" required="Postal code required" placeholder="Postal Code">
                      </div>
                    </div>
                  </div>
