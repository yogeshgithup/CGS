<%-- 
    Document   : adddietplan
    Created on : Oct 12, 2018, 11:43:46 AM
    Author     : sneh pael
--%>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Manage Batches</a>
          </div>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title" align="Center">ADD DIET PLAN</h4>
                ...
                <div class="card-body">
                  <form>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                        <div class="dropdown">
                          <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Batch Name
                          <span class="caret"></span></button>
                          <ul class="dropdown-menu">
                             <li><a href="#">YOGA</a></li>
                        ...
                        <div class="col-md-3">
                        <div class="dropdown">
                          <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Member Name
                          <span class="caret"></span></button>
                          <ul class="dropdown-menu">
                            <li><a href="#">BRANCH 1</a></li>
                            <li><a href="#">BRANCH 2</a></li>
