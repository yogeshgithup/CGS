<%-- 
    Document   : managegym
    Created on : 13 Oct, 2018, 9:03:01 PM
    Author     : Shravan
--%>
...
<%-- 
    ...
    Created on : Oct 11, 2018, 10:35:53 AM
    Author     : sneh pael
--%>
...
<head>
  ...
  <!-- CSS Files -->
  <link href="<%=application.getContextPath()%>/gymui/css/material-dashboard.css" rel="stylesheet" />
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active">
                <a class="nav-link " href="<%=application.getContextPath()%>/Viewgym" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-xl-12 col-lg-12">
                <div class="col-sm-4"> 
                        <a href="<%=application.getContextPath()%>/Viewpackage"> <button type="button" class="btn btn-primary pull-right">ADD GYM
                        </button></a>
                        </div>
            </div>
