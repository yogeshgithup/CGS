                        ...
                        <div class="card-body">
                            <form action="<%=application.getContextPath()%>/Aaddgym" method="post" onSubmit="return ValidateForm() && validateEmail()" name="frmSample">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 " >
                                        <h5><input type="radio" name="theme"value="demo1"><a href="<%=application.getContextPath()%>/gymui/ui/demo1.jsp">Demo1</a></h5> 
                                    </div>

                                    <div class="col-md-4 " >
                                        <h5><input type="radio" name="theme" value="demo2"><a href="<%=application.getContextPath()%>/gymui/ui/demo2.jsp">Demo2</a></h5> 
                                    </div>
                                </div>
