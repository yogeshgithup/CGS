        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                 <form action="<%=application.getContextPath()%>/UpdatePassword?msg=gymadmin" method="post">
                        <div id="slide12">
                  <div class="row">
...
<script>
   ...
   alert(pass);
//
   $.post("<%=application.getContextPath()%>/VerifyPassword?msg=gymadmin",{"pass":pass},function(data,status){
       alert(data);
       var y=data;
