<%-- 
    Document   : changepasswordmember
    Created on : 3 Mar, 2019, 3:12:02 PM
    Author     : Shravan
--%>
<%-- 
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                 <form action="<%=application.getContextPath()%>/UpdatePassword?msg=member" method="post">
                        <div id="slide12">
                  <div class="row">
...
<script>
   ...
   alert(pass);
//
   $.post("<%=application.getContextPath()%>/VerifyPassword?msg=member",{"pass":pass},function(data,status){
       alert(data);
       var y=data;
