          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                  <a href="<%=application.getContextPath()%>/gymui/pannel/addfacilities1.jsp"> <button class="btn btn-primary btn-block">ADD Facilities</button> </a>    
                <h4 class="card-title">View Facilities</h4>
              </div>
              <div class="card-body">
