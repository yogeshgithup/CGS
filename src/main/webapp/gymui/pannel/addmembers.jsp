...
<head>
  ...
  <link href="<%=application.getContextPath()%>/gymui/css/demo.css" rel="stylesheet" />
   <link rel="stylesheet" href="<%=application.getContextPath()%>/gymui/vendor/bootstrap/css/awesome-bootstrap-checkbox.css"/>
<!--    <link rel="stylesheet" href="<%=application.getContextPath()%>/gymui/vendor/bootstrap/css/bootstrap.css"/>
    <link rel="stylesheet" href="<%=application.getContextPath()%>/gymui/vendor/bootstrap/css/bootstrap.min.css"/>-->
</head>
...
<body class="dark-edition">
  ...
  <li class="nav-item">
         ...
         <li class="nav-item active">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="managebatches.html">
              <i class="material-icons"></i>
              <p>Manage Batches</p>
            </a>
          </li>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title" align="Center">ADD MEMBERS</h4>
