...
//function createFile1(fid)
//{
//    var ctrl=$("<input/>").attr({type:'file',id:fid,name:'eqimage',});
//    return ctrl;
//}
...
function createFile1(fid)
{
    var ctrl=$("<input/>").attr({type:'file',id:fid,name:'equimage',});
    return ctrl;
}
function createTextbox4(fid)
{
    var ctrl=$("<input/>").attr({
        type:'text',
        id:fid,
